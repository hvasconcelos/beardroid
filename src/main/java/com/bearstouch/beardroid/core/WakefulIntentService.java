...
public class WakefulIntentService extends IntentService {
    ...
    public static final String LOCK_NAME_STATIC = "com.bearstouch.smsscheduler.static";
    public static final String LOCK_NAME_LOCAL = "com.bearstouch.smsscheduler.local";

    protected static PowerManager.WakeLock lockStatic = null;
    protected PowerManager.WakeLock lockLocal = null;
