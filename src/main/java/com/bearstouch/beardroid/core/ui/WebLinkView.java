...
package com.bearstouch.beardroid.core.ui;
...
public class WebLinkView extends View
{
    ...
    {
       // TypedArray a = getContext().obtainStyledAttributes(attrs,R.styleable.SocialVoew);
       // String url = attrs.get("http://schemas.android.com/apk/com.bearstouch.beardroid","link");
       //String url = a.getString(R.styleable.WebLinkView_link);
       //String name = a.getString(R.styleable.WebLinkView_name);
       //this.http_url = url;
